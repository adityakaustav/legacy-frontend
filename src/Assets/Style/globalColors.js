...
// Default Dark Colors
export const defaultPrimaryDark = "#172B4D";
export const defaultSecondaryDark = "#253858";
export const defaultTertiaryDark = "#42526E";

// Default Mild Colors
export const defaultPrimaryMild = "#505F79";
export const defaultSecondaryMild = "#7A869A";
export const defaultTertiaryMild = "#A5ADBA";

// Default Light Colors
export const defaultPrimaryLight = "#FFFFFF";
export const defaultSecondaryLight = "#F4F5F7";
export const defaultTertiaryLight = "#DFE1E6";

// Default Red Colors
export const defaultPrimaryRed = "#DE350B";
export const defaultSecondaryRed = "#FF8F73";
export const defaultTertiaryRed = "#FFBDAD";

// Default Yellow Colors
export const defaultPrimaryYellow = "#FF991F";
export const defaultSecondaryYellow = "#FFC400";
export const defaultTertiaryYellow = "#FFF0B3";

// Default Green Colors
export const defaultPrimaryGreen = "#00875A";
export const defaultSecondaryGreen = "#57D9A3";
export const defaultTertiaryGreen = "#ABF5D1";

// Default Blue Colors
export const defaultPrimaryBlue = "#0052CC";
export const defaultSecondaryBlue = "#2684FF";
export const defaultTertiaryBlue = "#B3D4FF";

// Default Teal Colors
export const defaultPrimaryTeal = "#00A3BF";
export const defaultSecondaryTeal = "#00C7E6";
export const defaultTertiaryTeal = "#B3F5FF";

// Default Purple Colors
export const defaultPrimaryPurple = "#5243AA";
